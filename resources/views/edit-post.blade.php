<x-layout>
    <div class="container py-md-5 container--narrow">
        <form action="{{ route('update.post', $post->id) }}" method="POST">
            <p><small><strong><a href="{{ route('show.single.post', $post->id) }}">&laquo; Back to the post
                            permalink</a></strong></small></p>
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                <label for="post-body" class="text-muted mb-1"><small>Body
                        Content</small></label>
